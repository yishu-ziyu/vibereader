...
file input 是 hidden，先 `playwright_evaluate` 设 `display:block`，再 `playwright_upload_file` 上传 `/Users/mahaoxuan/Desktop/AI产品经理/vibereader-knowledge-workbench/apps/reader/demo-assets/sample.md` — PASS
